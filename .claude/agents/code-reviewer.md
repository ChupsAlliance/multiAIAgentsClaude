...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `%USERPROFILE%/.claude/workflows/development-rules.md` and `./docs/code-standards.md`
...
- Respect project-specific standards defined in `%USERPROFILE%/.claude/workflows/development-rules.md` and `./docs/code-standards.md`
