...
**Special cases:**
- `%USERPROFILE%/.claude/` skill updates: `perf(skill): improve git-manager token efficiency`
- `%USERPROFILE%/.claude/` new skills: `feat(skill): add database-optimizer`
...
```
Files: %USERPROFILE%/.claude/commands/new.md, src/feature.ts, package.json
Split into:
