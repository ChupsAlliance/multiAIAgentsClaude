  ...
  return (
    <div className="border-t border-vs-border shrink-0">
      <button
        ...
        className="w-full flex items-center gap-2 px-4 py-2 text-xs font-mono text-vs-muted hover:text-vs-text hover:bg-vs-overlay/5"
      >
      ...
      {expanded && (
        <div
          ref={containerRef}
          className="max-h-[300px] overflow-auto bg-vs-overlay/40 border-t border-vs-border scrollbar-thin"
        >
